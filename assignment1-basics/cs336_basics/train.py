...
parser.add_argument("--d_ff", type=int, default=1728, help="Feed-forward hidden dimension.")
parser.add_argument("--theta", type=float, default=10000.0, help="RoPE base frequency.")
parser.add_argument("--beta1", type=float, default=0.75, help="AdamW beta1.")
...
parser.add_argument("--alpha_max", type=float, default=2e-2, help="Peak AdamW learning rate (embedding + norms).")
parser.add_argument("--muon_lr", type=float, default=0.025, help="Peak Muon learning rate (2D hidden weights).")
